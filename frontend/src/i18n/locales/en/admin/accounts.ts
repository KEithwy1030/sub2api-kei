export default {
    accounts: {
      ...
      usageWindow: {
        ...
        grokRequests: 'Req',
        grokTokens: 'Tok',
        grokRateWindowRequests: 'Rate req',
        grokRateWindowTokens: 'Rate tok',
        grokRateWindowDisclaimer: 'Probe rate window only, not the account balance; a 429 status takes precedence.',
