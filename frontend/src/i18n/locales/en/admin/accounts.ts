export default {
    accounts: {
      ...
      usageWindow: {
        ...
        grokCredentialInvalidHistorical: 'OAuth credential is invalid; values below are historical',
        grokCredentialInvalidTooltip: 'OAuth credential is invalid and cannot be probed',
        grokProbeTransportError: 'Probe transport failed; check the Cloudflare-to-origin connection',
