...
func TestApplyGrokCLIProxyHeaders(t *testing.T) {
	...
	t.Run("accepts a supported operator override", func(t *testing.T) {
	...
	for _, version := range []string{"0.2.92", "0.2.93-beta.1", "0.2.093", "0.3", "1", "0.2.95+build.1"} {
		t.Run("rejects unsupported override "+version, func(t *testing.T) {
