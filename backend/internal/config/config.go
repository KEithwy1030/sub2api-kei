...
type GatewayConfig struct {
	...
	// CodexWebSearchBridgeEnabled: 是否为 Codex `/v1/responses` 自动注入原生 web_search 工具和桥接指令。
	// 默认关闭，避免为不需要联网的请求扩大上游工具集。
	CodexWebSearchBridgeEnabled bool `mapstructure:"codex_web_search_bridge_enabled"`
...
func setDefaults() {
	...
	viper.SetDefault("gateway.codex_web_search_bridge_enabled", false)
